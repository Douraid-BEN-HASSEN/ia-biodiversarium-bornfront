...
const Cam: React.FC<CamProps> = (Props) => {
    ...
    return (
        <Grid container spacing={1}>
            <Grid item xs={12}>
                <img id="videoDisplay"
                     style={{backgroundColor: 'black', width: '100%', height: `${window.screen.width / 3}px`}}
                     onClick={onSelectFish}></img>
            </Grid>
            ...
            <Grid item xs={10} sm={10} md={10} lg={10} xl={10} id='result'>
                {hasSelected.current ? <ResultTable fishResult={fishResult}/> :
                    <h2><i>Selectionnez un spécimen <TouchAppIcon/></i></h2>}
            </Grid>
